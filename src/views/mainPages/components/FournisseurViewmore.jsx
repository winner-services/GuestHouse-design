...
function FournisseurViewmore({ hideForm, singleSupplier }) {
    ...
    const getData = async () => {
        try {
            setLoader(true)
            const response = await fetch(`${BaseUrl}/getDebtsSupplier/${singleSupplier.id}`, {
                method: 'GET',
            ...
            if (res.data) {
                setData(res.data);
                if (Object.values(res.devise).length > 0) {
            ...
            <div className="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
                ...
                <div className="breadcrumb mb-24">
                    <ul className="flex-align gap-4">
                        ...
                        <li><a href="/main" className="text-gray-200 fw-normal text-15 hover-text-main-600">Fournisseurs</a></li>
                        <li> <span className="text-gray-500 fw-normal d-flex"><i className="ph ph-caret-right"></i></span> </li>
                ...
                <div className="tab-pane fade show active" id="pills-details" role="tabpanel"
                    ...
                    <div className="card mt-24">
                        <div className="card-header">
                            <span>Nom: {singleSupplier.name}</span><br />
                            <span>Genre: {singleSupplier.gender == "Masculin" ? 'Masculin' : 'Feminin'}</span><br />
                            <span>Addresse: {singleSupplier.address}</span><br />
                            <span>Telephone: {singleSupplier.phone}</span><br />
                            <span>Email: {singleSupplier.email}</span><br />
                        </div>
                        <div className="card-body">
                            <h4 className="d-flex justify-content-center">LISTE DES DETTES DU FOURNISSEUR</h4>
...
export default FournisseurViewmore