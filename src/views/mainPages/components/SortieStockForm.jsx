...
function SortieStockForm({ hideForm, singleClient }) {
    ...
    const submitData = async (e) => {
        ...
        let url = `createOutletStore`
        let method = 'POST'
        let generalForm = {}

        generalForm.sortie = base_form;
        generalForm.sortie_detail = pourchase_form;
    ...
    const addLignBtn = () => {
        if (!form.product_id || !form.output_quantity) {
            ...
            <div className="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
                ...
                <div className="breadcrumb mb-24">
                    <ul className="flex-align gap-4">
                        ...
                        <li><span className="text-main-600 fw-normal text-15">Sortie en stock</span></li>
                    </ul>
                </div>
                {/* Breadcrumb End */}
                                            ...
                                            <table className="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" value={form.output_quantity} onChange={(e) => { setForm({ ...form, output_quantity: e.target.value }) }} className="form-control" placeholder="Cliquer ici" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    </tr>
                                                    {
                                                        pourchase_form.map((item, index) => (
                                                            <tr key={index}>
                                                                ...
                                                                <td><span className="h6 mb-0 fw-medium text-gray-300">{item.output_quantity} {item.unit}</span></td>
                                                                <td>
