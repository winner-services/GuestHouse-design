                        ...
                        <div className="card-body">
                            <form action="#">
                                <div className="row gy-4">
                                    ...
                                    <div className="col-sm-6 col-xs-6">
                                        <label htmlFor="Piece" className="form-label mb-8 h6">Piece d'identite</label>
                                        <input type="text" className="form-control py-11" id="Piece" value={form.identity_document} onChange={(e) => { setForm({ ...form, identity_document: e.target.value }) }}
                                            placeholder="Piece d'identite" />
                                    </div>
                                    {form.identity_document ?
                                        <div className="col-sm-6 col-xs-6">
                                            <label htmlFor="part_number" className="form-label mb-8 h6">Numero de piece d'identite <span className="text-danger">*</span></label>
                                            <input type="text" className="form-control py-11" id="part_number" value={form.part_number} onChange={(e) => { setForm({ ...form, part_number: e.target.value }) }}
                                                placeholder="Entrer le numero du document" />
                                        </div> : null
                                    }
