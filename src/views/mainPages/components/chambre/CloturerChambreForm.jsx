...
function CloturerChambreForm({hideForm, singleRoom}) {
    ...
    return <>
        <div className="row">
            <h4>Cloturer le sejour du client de la chambre</h4>
            ...
            <div className="col-sm-12 col-xs-12 mb-8">
                <label htmlFor="email" className="form-label mb-8 h6">Chambre</label>
                <select id="" value={form.room_id} onChange={(e) => { setForm({ ...form, room_id: e.target.value }) }} className="form-control py-11">
...
export default CloturerChambreForm