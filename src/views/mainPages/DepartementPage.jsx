...
function DepartementPage() {
    ...
    const getData = async (page = 1, q = '') => {
        try {
            setLoader(true)
            const response = await fetch(`${BaseUrl}/getServicesData?page=${page}&q=${q}`, {
                method: 'GET',
    ...
    return <>
            ...
            <div className="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
                ...
                <div className="breadcrumb mb-24">
                    <ul className="flex-align gap-4">
                        ...
                        <li><span className="text-main-600 fw-normal text-15">Departements</span></li>
                    </ul>
                </div>
                {/* Breadcrumb End */}
        ...
        <Modal show={formVisible} onHide={hideForm} backdrop="static">
            <Modal.Header closeButton>
                <Modal.Title>Nouveau departement</Modal.Title>
            </Modal.Header>
            <Modal.Body>
